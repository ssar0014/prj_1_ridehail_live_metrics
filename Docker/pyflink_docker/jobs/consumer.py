...
kafka_sql_jar = os.path.join(
    ...
    "../lib/flink-sql-connector-kafka-3.4.0-1.20.jar",
)
kafka_jar = os.path.join(
    os.path.abspath(os.path.dirname(__file__)),
    "../lib/flink-connector-kafka-3.4.0-1.20.jar",
)
...
src_ddl = """
    CREATE TABLE users_schema_kafka (
        ...
        'connector' = 'kafka',
        'topic' = 'users_schema',
        'properties.bootstrap.servers' = 'kafka-broker-1:19092,kafka-broker-2:19092,kafka-broker-3:19092',
